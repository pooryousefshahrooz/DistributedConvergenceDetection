		 ...
		 struct bgp_info *binfo)
{
    ...
    zlog_debug (" __________________________and check if you need to replace best pair____________________________we are in  bgp_adj_out_set and selected is %s and peer is %s ",binfo->peer->host,peer->host);
		   ...
		   afi_t afi, safi_t safi)
{
 ...
 // zlog_debug (" !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! we are in bgp_adj_out_unset and peer is %s",peer->host);
...
//zlog_debug("-----------------------------sending fizzle back quickly");
  ...
  else
    {
        ...
        //zlog_debug (" !!!!!!!!!!!!!!!!!!!!!!!!!!!!!we are in else one !!!!!!!!!!!!!!!!!!!!!!!!!!!! we are in bgp_adj_out_unset and peer is %s",peer->host);
