...
void
bgp_fizzle_send (struct peer *peer,uint32_t passed_root_cause_event_id,uint32_t passed_time_stamp)
{
...
//     zlog_debug ("this is the root_cause_event_id");
  ...
  zlog_debug ("%s 4.this is the received_root_cause_event_id", str5);
    ...
    // it is waiting to receive a fizzle
    {
      ...
      bgp_fizzle_send (waiting_peers,rec_root_cause_event_id,rec_time_stamp);
    }
    else
    {
