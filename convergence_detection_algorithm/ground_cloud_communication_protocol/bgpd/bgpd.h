...
extern void delete_from_sent(struct sent** head_ref, struct peer* in_neighbour, uint32_t  in_E_id, char * in_prefix );
...
extern void  remove_neighbours_of_a_prefix(struct neighbours_of_a_prefix** head_ref, char * in_prefix);
extern void print_neighbours_of_a_prefix(struct neighbours_of_a_prefix ** head_ref);


struct senders_of_a_prefix{
    char * key_prefix[100];
    struct peer_list* peer_list;

    struct senders_of_a_prefix * next;
};
extern void add_to_senders_of_a_prefix(struct senders_of_a_prefix ** head_ref, char * in_prefix, struct peer_list * in_peer_list);
extern struct senders_of_a_prefix * get_from_senders_of_a_prefix(struct senders_of_a_prefix** head_ref, char * in_prefix);
extern void  remove_senders_of_a_prefix(struct senders_of_a_prefix** head_ref,char * in_prefix);
extern void add_to_senders(struct senders_of_a_prefix ** head_ref, struct peer_list * in_peer_list);
extern struct senders_of_a_prefix * get_from_senders(struct senders_of_a_prefix** head_ref);
extern void  remove_senders(struct senders_of_a_prefix** head_ref);
extern void print_senders(struct senders_of_a_prefix ** head_ref);

extern void print_senders_of_a_prefix(struct senders_of_a_prefix ** head_ref);
...
extern void delete_from_prefix_neighbour_pair(struct prefix_neighbour_pair ** head_ref, char * in_prefix,struct peer * in_peer);
...
//  struct peer * next_peer;
    ...
    struct neighbours_of_a_prefix * senders_of_prefix;
...
#define BGP_MSG_EVENT_DATA                   10
#define BGP_MSG_FIB_ENTRY                   13
