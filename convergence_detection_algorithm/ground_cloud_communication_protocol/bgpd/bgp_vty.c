                  ...
                  afi_t afi, safi_t safi, struct prefix_rd *prd)
{
  ...
  zlog_debug ("this is bgp_clear_prefix..................");
                  ...
                  if (rm->p.prefixlen == match.prefixlen)
                    {
                      ...
                      zlog_debug ("1 we are going to call bgp_process..................");
      ...
      if ((rn = bgp_node_match (rib, &match)) != NULL)
        {
          if (rn->p.prefixlen == match.prefixlen)
            {
              SET_FLAG (rn->flags, BGP_NODE_USER_CLEAR);
              zlog_debug ("we are going to call bgp_process..................");
       ...
       "IP prefix <network>/<length>, e.g., 35.0.0.0/8\n")
{
  ...
  zlog_debug ("3 we are going to call bgp_clear_prefix..................");
       ...
       "IPv6 prefix <network>/<length>,  e.g.,  3ffe::/16\n")
{
  ...
  zlog_debug ("1 we are going to call bgp_clear_prefix..................");
  ...
  else
  {
      ...
      zlog_debug ("we are going to call bgp_clear_prefix..................");
