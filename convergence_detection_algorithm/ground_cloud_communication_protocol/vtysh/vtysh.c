...
//zlog_debug ("we are in  vtysh_client_execute");
...
vtysh_execute_func (const char *line, int pager)
{
  ...
  //zlog_debug (".....this is the place you need to send event info to cloud");
  ...
  //zlog_debug ("after cmd_execute_command");
	...
	if (! strcmp(cmd->string,"configure terminal"))
	  {
        ...
        //zlog_debug ("lets call (*cmd->func) (cmd, vty, 0, NULL);");


		  (*cmd->func) (cmd, vty, 0, NULL);
      //zlog_debug ("after  call (*cmd->func) (cmd, vty, 0, NULL);");
	...
	for (i = 0; i < array_size(vtysh_client); i++)
	  {
	    if (cmd->daemon & vtysh_client[i].flag)
	      {
            //zlog_debug ("lets call vtysh_client_execute");
...
vtysh_execute_no_pager (const char *line)
{
    ...
    //zlog_debug (".................we are at vtysh_execute_no_pager...............******** ");
...
vtysh_execute (const char *line)
{
  ...
  //zlog_debug (".................we are at vtysh_execute...............******** ");
...
//zlog_debug ("................................******** we are at vtysh_exit********............................");
