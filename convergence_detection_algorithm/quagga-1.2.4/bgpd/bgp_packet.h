...
extern void bgp_fizzle_send (struct peer *, uint32_t , uint32_t ,uint32_t);
extern void bgp_convergence_send (struct peer *, uint32_t , uint32_t );
...
extern int bgp_nlri_parse (struct peer *, struct attr *, struct bgp_nlri *,uint32_t,uint32_t);
